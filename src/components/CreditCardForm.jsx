...
const CreditCardForm = ({ onCreditCardChange, className = '' }) => {
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <h3 className="text-lg font-semibold text-gray-800 mb-4">Datos de la Tarjeta de Crédito</h3>
      ...
      <div>
        ...
        {formData.brand_name && (
          <p className="text-green-600 text-xs mt-1">Marca detectada: {formData.brand_name}</p>
        )}
      </div>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              Tus datos de tarjeta están protegidos con encriptación SSL. No almacenamos información de tarjetas de crédito.
            </p>
          </div>
        </div>
      </div>
